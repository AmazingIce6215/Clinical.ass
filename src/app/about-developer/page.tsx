...
const principles: Array<{ icon: LucideIcon; title: string; description: string }> = [
  { icon: BookOpenCheck, title: "Built for clinical learning", description: "DxFlow combines structured encounter tools, case reporting, and formative practice for medical students." },
...
export default function AboutDeveloperPage() {
  return (
    <PublicPageShell eyebrow="About the project" title="A medical student-built clinical learning project" description="DxFlow is maintained by Rivindu, a medical student building structured tools for supervised clinical learning and practice. It is not affiliated with a university, hospital, professional body, or examination board.">
