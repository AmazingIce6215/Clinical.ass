...
const principles: Array<{ icon: LucideIcon; title: string; description: string }> = [
  { icon: BookOpenCheck, title: "Purpose-built modules", description: "Patient-encounter tools and practice modes are organized by purpose and can be used independently." },
...
export default function AboutDeveloperPage() {
  return (
    <PublicPageShell eyebrow="About the project" title="An independent clinical learning project" description="DxFlow is maintained by Rivindu, a medical student building independent tools for supervised clinical learning and practice. It is not affiliated with a university, hospital, professional body, or examination board.">
