...
export const metadata: Metadata = {
  ...
  description: "Learn how DxFlow is maintained and send product feedback without including patient information.",
};

const principles: Array<{ icon: LucideIcon; title: string; description: string }> = [
  { icon: BookOpenCheck, title: "Learner focused", description: "The product is designed around deliberate practice, structured case work, and useful review." },
...
export default function AboutDeveloperPage() {
  return (
    <PublicPageShell eyebrow="About the project" title="An independent clinical learning project" description="DxFlow is maintained by Rivindu, a medical student building structured tools for clinical reasoning practice. It is not affiliated with a university, hospital, professional body, or examination board.">
