    ...
    <div className="min-h-dvh bg-background">
          ...
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <p className="mt-4 text-sm leading-7 text-muted">
                Orizon is a learning tool. AI-generated material can be incomplete or wrong and should always be checked against current guidance, local protocols, and senior clinical judgement.
              </p>
            </div>
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <TrustPoint icon={LockKeyhole} title="Provider disclosure">AI requests pass through Orizon server routes to configured model providers.</TrustPoint>
            </div>
          </div>
        </section>
      ...
      <footer className="border-t border-border bg-surface">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-8 text-xs text-muted sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
          <p>© {new Date().getFullYear()} Orizon. Educational use only.</p>
...
function ProductSpecimen() {
  ...
  return (
    <div className="rounded-[18px] border border-border bg-background p-3 shadow-panel" aria-label="Orizon clinical case interface preview">
